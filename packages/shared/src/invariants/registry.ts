...
export const INVARIANTS: readonly Invariant[] = [
  ...
  { id:'I16', statement:'Local history is append-only; a revision inserts and never overwrites', test:'device-store exports no update path; revision inserts', source:'doc 16 F1' },
  { id:'I16b', statement:'A card contributes to the counters at most once, however often it is revised', test:'unique index on queued votes; vote_sent marker outlives the drain; enqueue refuses a second vote', source:'doc 16 F1, doc 26 S1' },
